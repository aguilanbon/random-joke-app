...
function ThumbButton() {
    ...
    const { setThumbsDown, setThumbsUp, setLiked, currentJoke, liked, disliked, setDisliked } = useContext(GlobalContext)
    ...
    return (
        <div className='w-full flex mt-8 justify-center items-center'>
           {isClicked ? <motion.h1 animate={{ opacity: [0,1], transition: { duration: 2 } }}>Move along.</motion.h1> : 
            <>
